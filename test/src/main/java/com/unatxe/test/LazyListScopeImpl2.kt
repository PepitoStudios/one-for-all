...
internal class LazyListScopeImpl2 : LazyListScope {

    private val _intervals = MutableIntervalList<LazyListIntervalContent2>()
    val intervals: IntervalList<LazyListIntervalContent2> = _intervals
...
internal class LazyListIntervalContent2(

...
internal fun rememberItemProvider(
    ...
    return remember(nearestItemsRangeState) {
        LazyListItemProviderImpl2(
            derivedStateOf {
                val listScope = LazyListScopeImpl2().apply(latestContent.value)
                LazyListItemsSnapshot2(
                    listScope.intervals,
...
@ExperimentalFoundationApi
internal class LazyListItemsSnapshot2(
    private val intervals: IntervalList<LazyListIntervalContent2>,
...
@ExperimentalFoundationApi
internal class LazyListItemProviderImpl2(
    private val itemsSnapshot: State<LazyListItemsSnapshot2>
) : LazyListItemProvider2 {

    override val itemScope = LazyItemScopeImpl2()
...
internal fun generateKeyToIndexMap(
    range: IntRange,
    list: IntervalList<LazyListIntervalContent2>
): Map<Any, Int> {
